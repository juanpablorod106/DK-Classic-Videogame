...
# Texto del menú
text_start = font1.render("Iniciar Juego", True, WHITE)
text_exit = font1.render("Salir", True, WHITE)

wallpaper = pygame.image.load("assets/images/8219895.webp")  # Asegúrate de poner la ruta correcta
wallpaper = pygame.transform.scale(wallpaper, (screen_width, screen_height))  # Escalar para ajustar al tamaño de la ventana
...
def soundtrack_main_menu():
# Cargar música
    pygame.mixer.music.load("assets/sounds/main-menu.mp3")  # Asegúrate de poner la ruta correcta
    ...
    for evento in pygame.event.get():
        ...
        if evento.type == pygame.MOUSEBUTTONDOWN:
            if button_start.collidepoint(evento.pos):
                ...
                in_menu = False  # Aquí puedes pasar a tu juego principal
            elif button_exit.collidepoint(evento.pos):
                pygame.quit()
                exit()

    # Dibujar el wallpaper
    #ventana.fill(WINE)
    ventana.blit(wallpaper,(0,0))
    # Dibujar botones
    pygame.draw.rect(ventana, BLACK, button_start)
    pygame.draw.rect(ventana, BLACK, button_exit)
...
hammer_stand = pygame.transform.scale(pygame.image.load('assets/images/mario/hammer_stand.png'),
                                      (2.4 * section_width, 2.5 * section_height))
...
hammer_overhead = pygame.transform.scale(pygame.image.load('assets/images/mario/hammer_overhead.png'),
                                         (1.5 * section_width, 3.5 * section_height))
